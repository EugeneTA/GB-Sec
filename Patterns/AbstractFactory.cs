...
using static Patterns.AbstractFactory;
...
namespace Patterns
{
    ...
    // обычно взаимодействуют между собой. Семейство продуктов может
    ...
    // время как внутри метода создаётся экземпляр конкретного продукта.
    ...
    // Каждый отдельный продукт семейства продуктов имеет базовый
    // интерфейс. Все вариации продукта реализуют этот интерфейс.
    ...
    public interface IAbstractProductB
    {
        ...
        // создаёт, имеют одинаковую вариацию и, следовательно, совместимы.
